...
<html style="background-image:url(../Images/background.jpg);">
	...
	<body>
		<form action="Employee-Delete-Make.php" method="GET">
				<legend><h1>Delete an Employee </h1></legend>
			<div>
				<?php
					$link = mysqli_connect("localhost:3306","root","PROJECT","Basic");
					$sql = "SELECT IRS_Number, Last_Name, First_Name FROM Employee";
					$result = mysqli_query($link,$sql);
					if ($result != 0) {
						echo '<label for="IRS_Number">Select an Employee: </label>
