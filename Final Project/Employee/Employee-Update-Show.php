...
<html style="background-image:url(../Images/background.jpg);">
	...
	<body>
		<form action="Employee-Update-Make.php" method="GET" align="center">
			<h1 style="font-family:Segoe UI;">Employee Details:  </h1>
				<?php
			...
			<div>
				...
				<input type="number" name="IRS_Number" required
				value="<?=$IRS_Number?>" >
			</div>
			<br><br>
			<div>
			...
			<div>
				...
				<input type="number" name="street_number" required
				value="<?=$Number?>" >
			</div>
			<br><br>
			<div>
